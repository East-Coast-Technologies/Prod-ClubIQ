...
- [Members API](#members-api)
  ...
  - [IDs](#ids)
  - [1. List Members](#1-list-members)
    - [Purpose](#purpose)
    - [Request Headers](#request-headers)
    - [Query Params](#query-params)
    - [Behavior](#behavior)
    - [Success Response](#success-response)
    - [Error: Client Sends `club_id` Query Param](#error-client-sends-clubid-query-param)
    - [Common Errors](#common-errors)
  - [2. Create Member](#2-create-member)
    - [Purpose](#purpose-1)
  ...
  - [3. Get Member by ID](#3-get-member-by-id)
    - [Purpose](#purpose-2)
    - [Request Headers](#request-headers-2)
    - [Success Response](#success-response-2)
    - [Common Errors](#common-errors-2)
  - [4. Update Member](#4-update-member)
    - [Purpose](#purpose-3)
    - [Request Headers](#request-headers-3)
    - [Request Body](#request-body-1)
    - [Allowed Fields](#allowed-fields)
    - [Rejected Fields](#rejected-fields-1)
    - [Success Response](#success-response-3)
    - [Error: Client Sends `club_id`](#error-client-sends-clubid-1)
    - [Common Errors](#common-errors-3)
  - [5. Delete Member](#5-delete-member)
    - [Purpose](#purpose-4)
    - [Request Headers](#request-headers-4)
    - [Success Response](#success-response-4)
    - [Common Errors](#common-errors-4)
  - [Frontend Example: List Members](#frontend-example-list-members)
  - [Frontend Example: Create Member](#frontend-example-create-member)
