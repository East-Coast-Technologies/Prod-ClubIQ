...
def create_app(config_class=Config):
    ...
    # Register Docker liveness routes outside legacy API visibility controls.
    from app.health.routes import backend_liveness_bp

    app.register_blueprint(backend_liveness_bp)
